...
<div class="content">
  <div class="container">
    <h1 style="display:none;">SMART</h1>
    <div class="row">
      <div class="col-xs-12 col-md-3"> 
        ...
        <div class="online_support block">
          ...
          <div class="block-content">
            <div class="sp_1">
              <p>Tư vấn bán hàng</p>
              <p>Ms. Nga: 0123 456 789</p>
            </div>
            <div class="sp_mail">
              <p>Email liên hệ</p>
              <p>support.smart@mail.com</p>
            </div>
          </div>
        </div>
        <!-- end support online --> 
              ...
              <div class="item">
                <div class="article"> <a href="index.php?controller=news_detail&id=20" class="image"> <img src="assets/frontend/images/anhbia.jpg" alt="Mua Macbook và Macbook Air Plus chính hãng ở đâu?" title="Mua Macbook và Macbook Air Plus chính hãng ở đâu?" class="img-responsive"> </a>
                  <div class="info">
                    ...
                    <p class="desc">
                    <p>Có thể nói rằng, MacBook đang là dòng laptop đắt đỏ nhất hiện nay. Chính vì vậy, lựa chọn địa chỉ cung cấp MacBook chính hãng là điều khiến không ít người dùng phải đau đầu. Vậy mua MacBook ở đâu uy tín?</p>
                    </p>
                  </div>
                </div>
              </div>
